...
Sebelum mengirim data ke dalam platform IoT, anda perlu untuk membuat akun terlebih dahulu, setelah itu login ke dalam platform. Berikut link untuk dapat mengakses [platform](https://dashboard.cec-unsrat.com/).
