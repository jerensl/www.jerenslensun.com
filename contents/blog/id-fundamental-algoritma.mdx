...
Bayangkan ketika kita akan membandingkan sebuah seberapa cepat seorang pembalap dengan kecepatan antara mode transportasi yang berbeda seperti mobil, motor dan lain lain tentu saja definisi cepat pada masing-masing transportasi akan berbeda, meskipun mereka sama-sama dikategorikan sebagai transportasi, begitupun halnya dengan algoritma yang dijalankan pada berbagai macam operating system dan perangkat keras yang berbeda-beda akan menghasilkan kecepatan yang berbeda pula. Pertanyaan selanjutnya adalah bagaimana cara kita dalam mengukur sebuah algoritma dengan berbagai macam variasi sistem, jika kita mengukurnya menggunakan kecepatan waktu nyata, sebuah algoritma akan sangat bergantung dengan sistem yang digunakan.

Dalam ilmu komputer, ada banyak cara untuk menyelesaikan suatu masalah dengan algoritma yang berbeda. Oleh karena itu, kita perlu menggunakan metode untuk membandingkan solusi agar bisa menilai mana yang lebih optimal. Metode tersebut harus memenuhi beberapa kriteria:
...
Untuk mengukur effisiensi dan efektifitas sebuah algoritma ada 2 cara yang kita gunakan, yaitu:
...
![Growth Rate Function](https://ik.imagekit.io/jerensl/growth-rate.png 'Growth Rate Function')
