...
namun kali ini kita bakal mengimplementasikan algoritnya secara langsung tanpa menggunakan standard library.
...
algoritma tersebut untuk menampung hasil dari pengganbungan.
