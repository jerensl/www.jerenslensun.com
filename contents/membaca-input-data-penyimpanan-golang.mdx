---
title: Mengolah input pada data penyimpanan golang
date: '2022-01-07'
cover: data-penyimpanan_oluhdr.avif
isPublished: true
description: Mengolah input berukuran besar bisa menjadi situasi yang tricky, apalagi kita harus mengambilnya dari data yang tidak terstruktur seperti file txt
tags: 'go'
---
