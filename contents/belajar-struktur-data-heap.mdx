---
title: Belajar Struktur Data Heap
date: '2022-01-17'
...
Heaps adalah struktur data yang berdasarkan pada complete binary tree, namun direpresentasikan melalui array. Ada dua tipe heaps, yaitu
...
Seabagai contoh kita hanya akan menggunakan MaxHeap. Disini Kita akan membuat sebuah struct yang diberi nama Heap untuk menyimpan value, dimana akan ada 2 value, yaitu :
...
1. Membuat variable maxHeaps, yang dimana merupakan struct kosong. Penggunaan **&** atau _dereferencing_ , yaitu untuk memanipulasi lansung data pada memory address pointer tersebut.
...
Pada method Insert yang menerima argumen nilai integer, lalu :

1. Kita akan langsung menggunakan append untuk memasukan nilai tersebut pada array Bucket.
2. Setelah itu kita akan melakukan increment pada Size, sehingga tiap ada nilai yang dimasukan size akan terus bertambah 1.
3. Setelah itu kita akan memanggil method heapifyUp yang akan kita buat nanti.
...
Biasanya untuk melakukan swaping kita perlu membuat temporary variable, namun dengan golang kita bisa langsung melakukan swaping seperti ini
...
Method heapifyUp dibuat dengan tujuan untuk mereorganisasi array sehingga nilai yang baru kita masukan berada di posisi yang sesuai.
...
Untuk langkah terakhir, kita akan mengetest secara langsung apa yang telah kita buat di atas, dan untuk log pada monitor akan menjadi seperti dibawah
