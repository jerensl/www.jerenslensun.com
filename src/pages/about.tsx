                    ...
                    <Disclosure as="div" className="mt-2">
                        {({ open }) => (
                            <>
                                ...
                                <Disclosure.Panel className="px-4 pt-4 pb-2 text-sm text-gray-500">
                                    Optimism, Ambitiousness and Integrity.
                                </Disclosure.Panel>
                            </>
                        )}
                    </Disclosure>
                    ...
                    <Disclosure as="div" className="mt-2">
                        {({ open }) => (
                            <>
                                ...
                                <Disclosure.Panel className="px-4 pt-4 pb-2 text-sm text-gray-500">
                                    When I am failing. People make mistakes and
                                    fail but what separates the winner and the
                                    loser is the ability to get up quickly when
                                    they are losing.
                                </Disclosure.Panel>
                            </>
                        )}
